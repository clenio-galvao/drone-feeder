...
public class Messages {
  ...
  public static final String VALIDATION_VIDEO_FILE_IS_EMPTY = "File cannot be empty.";
  public static final String VALIDATION_VIDEO_FILE_IS_REQUIRED = "File is required.";
  public static final String VALIDATION_VIDEO_DELIVERY_IS_EMPTY = "Delivery id cannot be empty.";
  public static final String VALIDATION_VIDEO_DELIVERY_IS_REQUIRED = "Delivery id is required.";
