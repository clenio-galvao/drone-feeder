...
public class Messages {
    ...
    public static final String VALIDATION_BRAND_SIZE = "Brand must have a minimum of 3 characters and a maximum of 100.";
    public static final String VALIDATION_MODEL_SIZE = "Model must have a minimum of 3 characters and a maximum of 240.";
