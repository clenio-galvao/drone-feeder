...
class DeliveryControllerTest {
  ...
  void findAllDeliveryTest() throws Exception {
    ...
    LocalDateTime now = LocalDateTime.now();
    dtoResponseInPage.setDateWithdrawal(now.minusHours(2).format(formatter));
    dtoResponseInPage.setLatitudeDelivery("23.0092");
    dtoResponseInPage.setLongitudeDelivery("43.3281");
    dtoResponseInPage.setDateDelivery(now.minusHours(1).format(formatter));
  ...
  void findByIdDeliveryTest() throws Exception {
    ...
    LocalDateTime now = LocalDateTime.now();
    dtoToResponse.setDateWithdrawal(now.minusHours(1).format(formatter));
    dtoToResponse.setLatitudeDelivery("23.0127");
    dtoToResponse.setLongitudeDelivery("43.3061");
    dtoToResponse.setDateDelivery(now.minusMinutes(30).format(formatter));
  ...
  void updateDeliveryTest() throws Exception {
    ...
    LocalDateTime now = LocalDateTime.now();
    dtoUpdated.setDateWithdrawal(now.minusHours(5).format(formatter));
    dtoUpdated.setLatitudeDelivery("23.9999");
    dtoUpdated.setLongitudeDelivery("43.9999");
    dtoUpdated.setDateDelivery(now.minusHours(4).format(formatter));
